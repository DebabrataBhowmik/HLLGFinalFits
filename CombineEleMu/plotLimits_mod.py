...
legend = ROOT.TLegend(0.35, 0.72, 0.9, 0.89)
...
axis[0].GetYaxis().SetLabelOffset(0.01)
...
axis[0].GetYaxis().SetTitleOffset(1.2)

if args.logy:
    axis[0].SetMinimum(0.1)  # we'll fix this later
    pads[0].SetLogy(True)
    # axis[0].GetYaxis().SetLabelOffset(0.05)
...
canv.Print('limit_new_cmp.pdf')
canv.Print('limit_new_cmp.png')
