...
def LimitVsM():
    ...
    for m in mass_interp:
        input_file = "./cards/higgsCombine_comb_{}.AsymptoticLimits.mH{}.root".format(m, m)
    ...
    mg.GetXaxis().SetTitle("m_{#mu#mu#gamma} (GeV)")
...
def SigVsM():
    ...
    significance_inj = []
    for m in mass_interp:
        input_file = "./cards/higgsCombine_comb_{}_expSignal1.Significance.mH{}.root".format(m, m)
        input_file_inj = "./cards/higgsCombine_comb_{}_expectSignalMass125.Significance.mH{}.root".format(m, m)
    ...
    gL.GetXaxis().SetTitle("m_{#mu#mu#gamma} (GeV)")
