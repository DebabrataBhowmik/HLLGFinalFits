...
#                         sd.loc[mask2, col_name] = round(1+_rate_df.iloc[idx][_syst["title"]].item(), 5) # 1 means central value
...
#                         mask2 = (sd["year"] == year) & (sd["cat"] == cat) & (sd["procOriginal"] == proc) & (sd["mass"] == mass)
#                         sd.loc[mask2, _syst["name"]] = round(1+_rate_df.iloc[idx][_syst["title"]].item(), 5) # 1 means central value
